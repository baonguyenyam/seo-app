...
export default function Contact() {
  ...
  return (
    <div>
      ...
      <form
        className="w-full mx-auto mt-10 text-left"
      ...
      >
        ...
        <div className="row mb-10">
          <button
            className="inline-block text-md bg-black text-white py-2 px-5 font-medium dark:bg-white dark:text-black dark:border-black border-2 border-black rounded-none hover:bg-white hover:text-black hover:border-black hover:shadow-lg transition-all duration-300 ease-in-out"
            id="formsubmit"
            type="submit"
          >
            Submit
